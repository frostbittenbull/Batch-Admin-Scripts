...
echo Выполняется удаление пункта "Подключить отключить сетевой диск":
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer" /v "NoNetConnectDisconnect" /t "REG_DWORD" /d "0x000000001" /f
